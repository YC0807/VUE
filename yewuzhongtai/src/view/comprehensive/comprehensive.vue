  ...
  <div class="app-contion">
    ...
    <div id="tableid">
      <el-table :data="tableData" border style="width: 100%" :height="tableHeight">
        ...
        <el-table-column prop="productionName" label="菜品名称" v-if="ShopName==='餐饮店'"></el-table-column>
        <el-table-column prop="productionName" label="商品名称" v-else></el-table-column>
        <el-table-column prop="pcounts" label="销量"></el-table-column>
        <el-table-column prop="price" label="单价"></el-table-column>
        <el-table-column prop="totalPayment" label="总价"></el-table-column>
      </el-table>
    </div>
  </div>
</template>
...
export default {
  computed: {
    ...mapState({
      ...
      ShopName: state => state.ShopName.type,
  ...
  methods: {
    ...
    todaypinlei() {
      ...
      _self.axios
        .post(_self.ApiUrl + "/home/getShopProductionSalesDetail", formData1)
        .then(response => {
