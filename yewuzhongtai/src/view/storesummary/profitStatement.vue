  ...
  <div class="app-contion">
    ...
    <el-collapse v-model="activeNames" @change="handleChange">
      <el-collapse-item name="1">
        ...
        <!--<b>注意事项：</b>可选的时间是为了满足查询早餐或者某个点的销售情况，结束子时间是包括该小时的数据。<br>-->
        <b>报表功能：</b>只能查到存在成本价的商品的销售情况毛利，没有成本价的商品不在此报表中体现。
        <br />
        <b>使用方法：</b>选择必选时间区间即可。
        <br />
        <b>使用案例：</b>查询2019年1月1日到2019年1月2日的毛利销售情况。选择时间：2019-01-01 00:00:00到 2019-01-02 23:59:59（或2019-01-03 00:00:00）
      </el-collapse-item>
    </el-collapse>
    ...
    <div id="tableid">
      <el-table :data="tableData" border style="width: 100%" :height="tableHeight">
        ...
        <el-table-column prop="profit_rate" label="利润率"></el-table-column>
        <el-table-column prop="sales" label="总销售额度"></el-table-column>
        <el-table-column prop="tc" label="产品数量"></el-table-column>
      </el-table>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getStatisticsNum: function(tableData) {
      ...
      var tc = 0;
      var profit_rate = 0;
      var totalActualPayment = 0;
      var result = {};
      for (var i = 0; i < length; i++) {
        var currentObj = tableData[i];
        totalCount = totalCount + currentObj.totalCount;
        sales = sales + currentObj.sales;
        cost = cost + currentObj.cost;
        profit = profit + currentObj.profit;
        tc = tc + currentObj.tc;
        profit_rate = profit_rate + currentObj.profit_rate;
        totalActualPayment = totalActualPayment + currentObj.totalActualPayment;
      }
      result["shop_name"] = "合计";
      result["cost"] = cost.toFixed(2);
      result["profit"] = profit.toFixed(2);
      result["tc"] = tc.toFixed(2);
      result["profit_rate"] = (profit_rate / length).toFixed(2);
      result["totalActualPayment"] = totalActualPayment.toFixed(2);
    ...
    searchs() {
      ...
      _self.axios
        .post(_self.ApiUrl + "/home/profitStatement", formData1)
        .then(response => {
