  ...
  <div class="app-contion">
    ...
    <el-collapse v-model="activeNames" @change="handleChange">
      <el-collapse-item name="1">
        ...
        <!--<br />-->
        <!--<b>使用案例：</b>查询2019年1月的4点到7点的销售情况。选择时间：(2019-01-01 到 2019-01-30 )-->
      </el-collapse-item>
    </el-collapse>
    ...
    <div id="tableid">
      <el-table :data="tableData" border style="width: 100%" :height="tableHeight">
        ...
        <el-table-column prop="totalcost" label="成本金额"></el-table-column>
        <el-table-column prop="sales2" label="销售金额"></el-table-column>
  ...
  methods: {
    ...
    getStatisticsNum: function(tableData) {
      ...
      for (var i = 0; i < length; i++) {
        ...
        totalcost = totalcost + currentObj.totalcost;
      ...
      result["totalcost"] = totalcost.toFixed(2);
      result["sales2"] = sales2.toFixed(2);
    ...
    searchs() {
      ...
      _self.axios
        .post(_self.ApiUrl + "/home/providerSalesTotal", formData1)
        .then(response => {
