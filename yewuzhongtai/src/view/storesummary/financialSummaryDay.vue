  ...
  <div class="app-contion">
    ...
    <div id="tableid">
      <el-table :data="tableData" border style="width: 100%" :height="tableHeight">
        ...
        <el-table-column prop="totalCount" label="销售数量"></el-table-column>
        <el-table-column prop="totalActualPayment" label="销售金额"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getStatisticsNum: function(tableData) {
      ...
      result["shopname"] = "合计";
      result["totalCount"] = totalCount.toFixed(2);
    ...
    searchs() {
      ...
      _self.axios
        .post(_self.ApiUrl + "/home/financialSummaryDay", formData1)
        .then(response => {
