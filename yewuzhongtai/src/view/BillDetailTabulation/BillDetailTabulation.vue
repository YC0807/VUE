<template>
  <div class="app-contion">
    ...
    <div style="position: fixed;bottom: 190px;right: 0;">
      <el-pagination
        background
...
export default {
  ...
  data() {
    return {
      ...
      value2: "",
      value3: "",
      tableHeight: window.innerHeight - 405,
      total: 1,
      pagesize: 10,
      currentPage: 1,
      getall: 0,
  ...
  watch: {
    getall: function() {
      let _self = this;
      _self.alldata = [];
      for (let i = 1; i < _self.pages + 1; i++) {
        let formData1 = new FormData();
        formData1.append("pageNum", i);
  ...
  methods: {
    ...
    searchs() {
      ...
      _self.axios
        ...
        .then(response => {
          if (response.data.errcode == "0") {
            // var serverDataArr = response.data.data.data.list;
