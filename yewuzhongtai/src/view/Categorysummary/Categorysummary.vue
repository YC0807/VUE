  ...
  <div class="app-contion">
    ...
    <div id="tableid">
      <el-table :data="tableData" border style="width: 100%" :height="tableHeight">
        ...
        <el-table-column prop="totalPayment" label="销售总额"></el-table-column>
        <el-table-column prop="salesPCT" label="销售占比(单位:%)"></el-table-column>
      </el-table>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      user: this.$store.state.ShopName.type
    };
  },
  ...
  methods: {
    exportExcel() {
      require.ensure([], () => {
        ...
        const tHeader = ["品类名称", "销量", "销售总额", "销售占比"];
        // 上面设置Excel的表格第一行的标题
        const filterVal = ["categoryName", "tc", "totalPayment", "salesPCT"];
    ...
    getStatisticsNum: function(tableData) {
      ...
      for (var i = 0; i < length; i++) {
        ...
        salesPCT = salesPCT + currentObj.salesPCT;
      }
      result["categoryName"] = "合计";
      result["productionName"] = "";
      result["tc"] = tc;
      result["salesPCT"] = salesPCT;
    ...
    todaypinlei() {
      ...
      _self.axios
        .post(_self.ApiUrl + "/home/categorySalesRanking", formData1)
        .then(response => {
    ...
    choseurl(user) {
      let _self = this;
      if (user == "餐饮店") {
        _self.searchurl = _self.ApiUrl + "/home/categorySalesRanking";
      }
      if (user == "品牌店" || user == "特卖店") {
        _self.searchurl = _self.ApiUrl + "/home/RetailCatSales";
      }
    },
    searchs() {
      let _self = this;
