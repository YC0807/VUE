  ...
  <div class="app-contion">
    <div style="text-align: center;font-size: 16px;display: flex;">
      ...
      >
        ...
        <div style="text-align: left;margin-left: 25px;" class="collectList">
          <p>
            <span class="title">门店：</span>
            {{goodslist2.shopName}}
          </p>
          <p>
            <span class="title">开始营业日期：</span>
            {{time[0]}}
          </p>
          <p>
            <span class="title">结束营业时间：</span>
            {{time[1]}}
          </p>
          <p>
          ...
          <p>
            <span class="title">内合计：</span>
            {{goodslist2.memTotalAmount}}
          </p>
          <p>
            <span class="title">外合计：</span>
            {{goodslist2.totalMoney}}
          </p>
        </div>
      </div>
