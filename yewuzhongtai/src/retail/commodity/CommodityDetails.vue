        ...
        <el-col :span="12">
          <div class="grid-content bg-purple f-s">
            <el-form-item label="商品名称" prop="productionName">
              <el-input v-model="ruleForm.productionName" placeholder="请输入商品名称" disabled></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <div class="grid-content bg-purple f-s">
            <el-form-item label="一级品类" prop="CategoryName">
              <el-select v-model="ruleForm.CategoryName" :multiple='false' filterable allow-create default-first-option
                placeholder="请选择商品品类" style='width: 100%;' @change="wareblur" disabled>
          ...
          <div class="grid-content bg-purple f-s">
            <el-form-item label="二级品类" prop="shopteam2">
              <el-select v-model="ruleForm.shopteam2" :multiple='false' filterable allow-create default-first-option
                placeholder="请选择商品品类" style='width: 100%;' @change="wareblur2" disabled>
          ...
          <div class="grid-content bg-purple f-s">
            <el-form-item label="三级品类" prop="shoplei">
              <el-select v-model="ruleForm.shoplei" :multiple='false' filterable allow-create default-first-option
                placeholder="请选择商品品类" style='width: 100%;' @change="wareblur3" disabled>
        ...
        <!-- <el-col :span="12">
          <div class="grid-content bg-purple f-s">
            <el-form-item label="商品编码" prop="productionCode">
              <el-input v-model="ruleForm.productionCode" placeholder="商品编码为四位数字形式" disabled></el-input>
            </el-form-item>
          </div>
        </el-col> -->
        <el-col :span="12">
          <div class="grid-content bg-purple f-s">
            <el-form-item label="商品条形码" prop="barCode">
              <el-input v-model="ruleForm.barCode" placeholder="请输入商品条形码" disabled></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <div class="grid-content bg-purple f-s">
            <el-form-item label="供应商名称" prop="providerName">
              <el-select v-model="ruleForm.providerName" :multiple='false' filterable allow-create default-first-option
                placeholder="请选择供应商名称" style='width: 100%;' @change="providerchange" disabled>
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple f-s">
            <el-form-item label="成本价" prop="cost">
              <el-input v-model="ruleForm.cost" placeholder="请输入成本价" disabled></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <div class="grid-content bg-purple f-s">
            <el-form-item label="零售价" prop="price">
              <el-input v-model="ruleForm.price" placeholder="请输入零售价" disabled></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <div class="grid-content bg-purple f-s">
            <el-form-item label="商品单位" prop="unit">
              <el-input v-model="ruleForm.unit" placeholder="请输入商品单位" disabled></el-input>
            </el-form-item>
          </div>
        </el-col>
         <el-col :span="12">
          <div class="grid-content bg-purple f-s">
            <el-form-item label="商品规格" prop="CommoditySize">
              <el-input v-model="ruleForm.CommoditySize" placeholder="请输入商品规格" disabled></el-input>
            </el-form-item>
          </div>
        </el-col>
         <el-col :span="12">
          <div class="grid-content bg-purple f-s">
            <el-form-item label="商品品牌" prop="CommodityBrand">
              <el-input v-model="ruleForm.CommodityBrand" placeholder="请输入商品品牌" disabled></el-input>
            </el-form-item>
          </div>
        </el-col>
