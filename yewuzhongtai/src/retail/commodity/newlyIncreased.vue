        ...
        <el-col :span="12">
          <div class="grid-content bg-purple f-s footer-increased">
            <el-form-item class='btnbox-increased'>
              <el-button type="primary" @click="submitForm('ruleForm')" class='wids'>提交</el-button>
      ...
      submitForm(formName) {
        ...
        _self.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            _self.axios.post(_self.ApiurlStorehouse + '/productManagement/addNewGoods', formData, {
          // 单独配置
